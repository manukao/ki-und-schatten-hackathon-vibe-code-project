...
class UltraDetailKategorieAnalyse {
    ...
    async erstelleUltraAnnotiertesBild(originalImg, regionen, ultraStats, dominanz, bildname) {
        ...
        const outputDir = path.join(__dirname, 'ultra_detail_bilder_alle_50');
    ...
    speichereErgebnisse() {
        ...
        console.log(`🖼️ Annotierte Bilder gespeichert in: ./ultra_detail_bilder_alle_50/`);
    }
    ...
    zeigeZusammenfassung() {
        ...
        console.log(`\n📁 Alle ${this.results.length} ultra-detail-annotierten Bilder: ./ultra_detail_bilder_alle_50/`);
    }
}
